...
class Auth0Service {
  ...
  async groupsFromUserId (userId) {
    return this._fieldFromUserId(userId, 'groups', this.groupsFromUserIdCache)
  } // groupsFromUserId
  ...
  async _fieldFromUserId (userId, field, cache) {
    ...
    this._addToCache(userId, body.email, body.groups || [])
  ...
  _addToCache (userId, email, groups) {
    ...
    this.cacheService.set(GROUPS_FROM_USER_ID_CACHE_NAME, userId, roles)
  } // _addToCache
